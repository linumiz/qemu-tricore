...
DEF_HELPER_FLAGS_2(mulp_b, TCG_CALL_NO_RWG_SE, i64, i32, i32)
...
DEF_HELPER_3(divide64, i64, env, i64, i64)
DEF_HELPER_3(divide64_u, i64, env, i64, i64)
DEF_HELPER_3(reminder64, i64, env, i64, i64)
DEF_HELPER_3(reminder64_u, i64, env, i64, i64)
/* mulh */
...
DEF_HELPER_2(qemu_excp, void, env, i32)
DEF_HELPER_2(debug_semihost, void, env, i32)

DEF_HELPER_2(fabs, i32, env, i32)
DEF_HELPER_3(fmin, i32, env, i32, i32)
DEF_HELPER_3(fmax, i32, env, i32, i32)
DEF_HELPER_2(ftoin, i32, env, i32)
DEF_HELPER_2(ftodf, i64, env, i32)
DEF_HELPER_2(fneg, i32, env, i32)
DEF_HELPER_2(ultodf, i64, env, i64)
DEF_HELPER_2(ltodf, i64, env, i64)
DEF_HELPER_2(utodf, i64, env, i32)
DEF_HELPER_2(itodf, i64, env, i32)

DEF_HELPER_2(dabs, i64, env, i64)
DEF_HELPER_2(dftoi, i32, env, i64)
DEF_HELPER_2(dftoiz, i32, env, i64)
DEF_HELPER_2(dftou, i32, env, i64)
DEF_HELPER_2(dftouz, i32, env, i64)
DEF_HELPER_2(dftof, i32, env, i64)
DEF_HELPER_2(dftoin, i32, env, i64)
DEF_HELPER_2(dftol, i64, env, i64)
DEF_HELPER_2(dftolz, i64, env, i64)
DEF_HELPER_2(dftoul, i64, env, i64)
DEF_HELPER_2(dftoulz, i64, env, i64)
DEF_HELPER_2(dqseed, i64, env, i64)
DEF_HELPER_2(dneg, i64, env, i64)
DEF_HELPER_3(dcmp, i32, env, i64, i64)
DEF_HELPER_3(ddiv, i64, env, i64, i64)
DEF_HELPER_3(dmul, i64, env, i64, i64)
DEF_HELPER_3(dmax, i64, env, i64, i64)
DEF_HELPER_3(dmin, i64, env, i64, i64)
DEF_HELPER_3(dadd, i64, env, i64, i64)
DEF_HELPER_3(dsub, i64, env, i64, i64)
DEF_HELPER_4(dmadd, i64, env, i64, i64, i64)
DEF_HELPER_4(dmsub, i64, env, i64, i64, i64)
